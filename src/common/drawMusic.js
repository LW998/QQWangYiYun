export default class DrawMusic {
    ...
    drawMusicParticle() {
        ...
        nowData.map((v, i) => {
            ...
            if (v > 0 && Math.random() < 0.02) {
                musicParticleList.push(new Particle({
                    pageWidth,
                    pageHeight,
                    fftSize,
                    value: v,
    ...
    draw() {
        ...
        const drawMusicType = 1
        const drawMusicStyle = 'rect';
