<template>
  <main class="topDetail">
    ...
    <section class="Listinfo">
      ...
      <a href="javascript:;" class="playBtn" @click="playAll"><svg
          class="icon_svg">
          <use xlink:href="#icon_arr"><svg id="icon_arr"
              viewBox="0 0 32 32">
    ...
    <section class="songListBox">
      <div class="songNum">
        歌单
        <span class=""
          class="totalNum">共{{topDetailList.total}}首</span>
      </div>
      <ul class="songList">
        <li class="songListItem"
          ...
          <div class="indexBox" @click="playSong(item.songmid)">
            ...
            <p class="indexChange">
              <svg class="icon_svg">
                <use xlink:href="#icon_rank_up"
                  v-if="item.rankType==1">
	...
	C23.5,23.2,17.3,32,4,32c-1.7,0-3-1.4-3-3c0-1.7,1.4-3,3-3C13.3,25.9,17.1,20.5,15.9,8z">
                ...
                <use xlink:href="#icon_rank_down"
                  v-if="item.rankType==2"><svg id="icon_rank_down"
                    viewBox="0 0 32 32">
                    <path fill="#979797"
	...
	C23.5,8.8,17.3,0,4,0c-1.7,0-3,1.4-3,3s1.4,3,3,3C13.3,6.1,17.1,11.5,15.9,24z"></path>
                ...
                <use xlink:href="#icon_rank_invariant"
                  v-if="item.rankType==3"><svg
                    id="icon_rank_invariant" viewBox="0 0 32 32">
                    <path fill="#979797"
	...
	z M2.7,14.3C1.7,14.3,1,15,1,16c0,1,0.8,1.7,1.7,1.7h26.6c1,0,1.7-0.8,1.7-1.7c0-1-0.8-1.7-1.7-1.7H2.7z">
                ...
                <use xlink:href="#icon_rank_new"
                  v-if="item.rankType==4"><svg id="icon_rank_new"
                    viewBox="0 0 32 10">
                    <text transform="matrix(1 0 0 1 -0.3998 10)"
                      fill="#F56273"
                      font-family="'PingFang-SC-Medium'"
                      font-size="14">NEW</text>
                  </svg></use>
                <use xlink:href="#icon_rank_surge"
                  v-if="item.rankType==6"><svg id="icon_rank_surge"
                    viewBox="0 0 32 32">
                    <path fill="#f56273"
                      d="M11.9,14.4c-1.3,1.2-3.3,1-4.4-0.5S6.6,10.2,7.9,9l8.8-8.2c1.1-1,2.7-1.1,3.9-0.1l9.3,8.2
	c1.4,1.2,1.6,3.4,0.5,4.9s-3,1.8-4.4,0.6L18.7,8L11.9,14.4z M15.9,8c-0.2-1.7,1.1-3.2,2.7-3.3c1.7-0.2,3.2,1.1,3.3,2.7
